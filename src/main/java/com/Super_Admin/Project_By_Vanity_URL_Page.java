...
public class Project_By_Vanity_URL_Page  extends Base_Pace
{
	...
	@FindBy(xpath="//span[normalize-space()='Uns']")
	...
	public Project_By_Vanity_URL_Page()
	{
	...
	public void Submit_UNS_Contract() throws InterruptedException
	{
		...
		Select sale = new Select(driver.findElement(By.xpath("//select[@id='home-salesperson-id']")));
		sale.selectByValue("30002");

		Thread.sleep(1000);
		Select Prog = new Select(driver.findElement(By.xpath("//select[@id='program-id']")));			
		Prog.selectByValue("537");
		Thread.sleep(2000);
