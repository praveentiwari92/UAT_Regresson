...
public class Increasing_price_at_COC_Page extends Base_Pace
{
	...
	// Credit Decision
		...
		@FindBy(xpath="//body/div[@id='container']/div[@id='envelope']/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[2]/div[7]/div[1]/div[4]/div[2]/button[1]/div[1]/div[1]") 			  
		...
		@FindBy(xpath="//body/div[@id='container']/div[@id='envelope']/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[8]/div[1]/div[1]/div[4]/div[1]/button[1]/div[1]/div[1]") 			  
		...
		@FindBy(xpath="//body/div[@id='container']/div[@id='envelope']/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[6]/div[1]/div[1]/div[4]/div[1]/button[1]/div[1]/div[1]") 
...
//		WebElement Initial_Sign_Btn_15;
	...
	public Increasing_price_at_COC_Page()
	{
	...
	public void Select_Contractor() throws InterruptedException
	{
		...
		Enter_Address.clear();
		Enter_Address.sendKeys("3718 West Oakland Park Boulevard");
		Thread.sleep(2000);
...
//		Thread.sleep(30000);
	...
	public void Submit_NTP() throws InterruptedException
	{
		...
		public void Funding_Tab() throws InterruptedException, IOException
		{
			...
			// Increase project cost to 20%
			Thread.sleep(1000);
			driver.findElement(By.xpath("//body[1]/div[9]/div[2]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/form[1]/div[3]/div[1]/div[3]/div[1]/div[1]/div[3]/div[1]/a[1]")).click();
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//button[@title='Select Improvement Type']")).click();

			Thread.sleep(2000);	
			driver.findElement(By.xpath("//span[normalize-space()='Additional scope - rewiring']")).click();
			Thread.sleep(2000);
			Quantity_Value2.sendKeys("1");
			Thread.sleep(2000);
			Cost_Value.clear();
			Cost_Value.sendKeys("40800");
			Thread.sleep(2000);
