...
public class UNS_Solar_Project_Page extends Base_Pace{
...
// NTP TAB
	...
	WebElement Click_Approved;
	
	@FindBy(xpath="//button[normalize-space()='Success']") 
	WebElement Click_Success;
	...
	@FindBy(xpath="//button[@id='Completion-Call']") 
	WebElement CC_Click;
	
	@FindBy(xpath="//a[normalize-space()='Daily Payment Report - Unsecured']") 
	WebElement Unsecured_Report_Click;
...
// Courtesy Call
	...
	@FindBy(xpath="//a[normalize-space()='Additional Review']") 
	WebElement Additional_Review;
	
	@FindBy(xpath="//div[@class='modal-dialog modal-add custom-modal modal-lock-project']//button[@aria-label='Close']") 
	WebElement Close_Additional_Review_Popup;
	...
	// Initializing page object
		...
		public void Submit_UNS_Solar_Contract() throws InterruptedException
		{
			...
			js2.executeScript("window.scrollBy(0,-550)", "");
				...
				product_type.selectByValue("UNS Solar");
...
//				Thread.sleep(1000);
		...
		// Curtsy Call 
			...
			Thread.sleep(3000);
			Close_Additional_Review_Popup.click();
