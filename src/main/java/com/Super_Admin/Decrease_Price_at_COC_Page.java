...
public class Decrease_Price_at_COC_Page extends Base_Pace 
{
	...
	public Decrease_Price_at_COC_Page()
	{	 
	...
	//	Program_drp.click();
		...
		Thread.sleep(2000);	
		driver.findElement(By.xpath("//div[@aria-expanded='true']//span[@class='text'][normalize-space()='Air Sealing']")).click();
		Thread.sleep(2000);
