...
public class UNS_Solar_FL_Vanity_URL_Project_Page  extends Base_Pace
{
	...
	@FindBy(xpath="//input[@id='first-1']") 
	WebElement F_Name;

	@FindBy(xpath="//input[@id='last-1']") 
	WebElement L_Name;
	...
	WebElement Check_Address_Btn;

	@FindBy(xpath="//button[@id='submit-button']") 
	WebElement Property_Info_Next_Btn;
	...
	@FindBy(xpath = "(//span[normalize-space()='UNS Solar'])[1]")
	...
	@FindBy(xpath="//div[contains(text(),'adminuser233 tets')]")
	...
	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[1]/div[1]/div[4]/div[1]/button[1]/div[1]/div[1]/i[1]") 			  
	WebElement Initial_Sign_Btn_2;
	
	@FindBy(xpath="//button[normalize-space()='Adopt and Sign']") 
	WebElement Adopt_and_Initial_Btn;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[1]/button[1]/div[1]/div[1]/i[1]")
	WebElement Initial_Sign_Btn_3;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[2]/button[1]/div[1]/div[1]/i[1]") 			  
	WebElement Initial_Sign_Btn_4;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[3]/button[1]/div[1]/div[1]/i[1]") 			  		 
	WebElement Initial_Sign_Btn_5;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[4]/button[1]/div[1]/div[1]/i[1]") 	
	WebElement Initial_Sign_Btn_6;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[5]/button[1]/div[1]/div[1]/i[1]")
				  
	WebElement Initial_Sign_Btn_7;

	@FindBy(xpath="/html[1]/body[1]/div[1]/div[2]/div[1]/section[1]/div[1]/div[1]/div[2]/div[4]/div[1]/section[3]/div[4]/div[1]/div[4]/div[6]/button[1]/div[1]/div[1]/i[1]") 			  
	...
	public UNS_Solar_FL_Vanity_URL_Project_Page()
	{
	...
	{
		Thread.sleep(2000);
		F_Name.sendKeys("Pratik");
		L_Name.sendKeys("TestCase");
		Email.sendKeys("pratik3@yopmail.com");
		Thread.sleep(2000);
		Address.sendKeys("3710 Jason Dwelley Parkway"); // FL State
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		Phone_No.sendKeys("(984) 673-8254");
		Thread.sleep(1000);
	...
	public void Funding_Tab() throws Exception
	{
		...
		// Write Invoice Number in CSV File	
		...
		// Uploading file for update invoice status to PAID
		Thread.sleep(3000);

		WebElement Invoice_Status = driver.findElement(By.xpath("//div[@id='change-invoice-status']//input[@name='importcsv']"));

		if(TC_TestUtil.isWindows()) {
			Invoice_Status.sendKeys(projectRootPath + "\\" +"Documents\\Sample.csv"); //Uploading the file
		}else {
			Invoice_Status.sendKeys(projectRootPath + "/" +"Documents/Sample.csv"); 
		}
