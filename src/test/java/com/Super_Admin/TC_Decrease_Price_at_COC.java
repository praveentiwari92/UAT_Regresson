...
public class TC_Decrease_Price_at_COC extends Base_Pace {
	
	Decrease_Price_at_COC_Page Decrease_Amount;
	Login_Page Login_Page;
	Create_PACE_Project_Page PACE;
	
	public TC_Decrease_Price_at_COC()
	{
		super();
	}
	...
	public void TestSetup() throws InterruptedException {
		...
		Decrease_Amount = new Decrease_Price_at_COC_Page();
